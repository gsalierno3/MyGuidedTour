...
public class MultifamilyActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        projects.add(new Project(getString(R.string.residential1_name), R.drawable.multi_federal, 41.008970, -74300426,
                getString(R.string.residential1_text)));
        projects.add(new Project(getString(R.string.residential2_name), R.drawable.multi_rahway,40.609281, -74.268479,
                getString(R.string.residential2_text)));
        projects.add(new Project(getString(R.string.residential3_name), R.drawable.multi_rutherford,
                getString(R.string.residential3_text)));
        projects.add(new Project(getString(R.string.residential4_name), R.drawable.multi_wallington1,40.858851, -74.116404,
                getString(R.string.residential4_text)));
